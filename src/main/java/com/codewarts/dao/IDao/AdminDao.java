...
public interface AdminDao {
    ...
    void saveChild(int idChild, LocalDate date, String name, String surname, int idGroup, String mother,
    ...
    void addChild(LocalDate date, String name, String surname, String mother, String father, String phoneMother,
