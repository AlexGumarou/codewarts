        ...
        <div class='overlay'>
            <div class='content'>
                <div align="center">
                    ...
                    <h3 class='welcome2' style="color: aqua" ><em>${item.birthdayDate} <spring:message code="app.admin.birthday"/>
                    ...
                    <form name="test" method="post" action="/admin/search">
                        ...
                        <button class='ghost-round full-width' type="submit" name="button"><spring:message code="app.admin.find"/></button>
                    </form>
                    <form name="test" method="get" action="/admin/addChild">
                        <button class='ghost-round full-width' type="submit"><spring:message code="app.admin.addChild"/></button>
                    </form>
                    <form name="test" method="get" action="/admin/addPayment">
                        <button class='ghost-round full-width' type="submit"><spring:message code="app.admin.addPayments"/></button>
                    </form>
                    <form name="test" method="get" action="/admin/addGroup">
                        <button class='ghost-round full-width' type="submit"><spring:message code="app.admin.addGroup"/></button>
                    </form>
